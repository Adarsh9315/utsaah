              ...
              <article className="blog_item">
                ...
                <div className="blog_details">
                  ...
                  <p>
                    ...
                    have don&lsquo;t stars is that he earth it first without heaven in
                  ...
                  <li>
                    <a href="#">
                      {/* <img
                        ...
                        alt=""
                      /> */}
                      <Image src={post5} alt="" className="mg-fluid"/>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      {/* <img
                        ...
                        alt=""
                      /> */}
                      <Image src={post6} alt="" className="mg-fluid"/>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      {/* <img
                        ...
                        alt=""
                      /> */}
                      <Image src={post7} alt="" className="mg-fluid"/>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      {/* <img
                        ...
                        alt=""
                      /> */}
                      <Image src={post8} alt="" className="mg-fluid"/>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      {/* <img
                        ...
                        alt=""
                      /> */}
                      <Image src={post9} alt="" className="mg-fluid"/>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      {/* <img
                        ...
                        alt=""
                      /> */}
                      <Image src={post10} alt="" className="mg-fluid"/>
                    </a>
                  </li>
                </ul>
              </aside>
